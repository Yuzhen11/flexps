...
enum class Flag : char { kExit, kBarrier, kResetWorkerInModel, kClock, kAdd, kGet, kOther };
static const char* FlagName[] = {"kExit", "kBarrier", "kResetWorkerInModel", "kClock", "kAdd", "kGet", "kOther"};
