...
class AbstractStorage {
 public:
  ...
  Message Get(Message& msg, bool is_chunk = false) {
    ...
    third_party::SArray<char> reply_vals = SubGet(reply_keys, is_chunk);
  ...
  virtual third_party::SArray<char> SubGet(const third_party::SArray<Key>& typed_keys, bool is_chunk) = 0;
