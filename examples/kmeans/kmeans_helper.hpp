...
template<typename T>
void random_init(int K, int num_features, const std::vector<T> &data,
...
template<typename T>
void init_centers(int K, int num_features, 
                  std::vector<T> data, std::vector<std::vector<float>>& params, std::string init_mode) {
...
void test_error(const std::vector<std::vector<float>>& params,
                const std::vector<T> &data, int iter, int K,
